    ...
    <div className="row skill">
      ...
      <div className="nine columns main-col">
        <div className="bars">
          ...
          <Grid columns="equal">
            <Grid.Column>
              ...
              <Grid.Row>
                <Grid.Column className="skill-name">NextJS</Grid.Column>
                <Grid.Column>
                  <Rating
                    size={"huge"}
                    defaultRating={3}
            ...
            <Grid.Column>
              ...
              <Grid.Row>
                <Grid.Column className="skill-name">HTML & CSS</Grid.Column>
                <Grid.Column>
                  <Rating
                    size={"huge"}
                    defaultRating={4}
        ...
        <div className="bars m-t-32">
          ...
          <ul className="skills">
            <li>
              <span>Basics of AWS</span>
            </li>
            <li>
              <span>Basics of React Native</span>
            </li>
            <li>
              <span>Webpack bundling</span>
            </li>
            <li>
              <span>Basics of Docker and Kubernetes</span>
            </li>
            <li>
              <span>
                Exposure to UI libraries like Ant, Redux-forms, semantic-ui, bootstrap, Ag-grid, Highcharts
              </span>
            </li>
          </ul>
        </div>
